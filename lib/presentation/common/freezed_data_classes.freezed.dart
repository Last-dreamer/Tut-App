...
class _$RegisterObjectTearOff {
  ...
  _RegisterObject call(String userName, String email, String password,
      String confirmPassword, String profilePicture) {
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.email, this.password,
      this.confirmPassword, this.profilePicture);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, email: $email, password: $password, confirmPassword: $confirmPassword, profilePicture: $profilePicture)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(String userName, String email, String password,
      String confirmPassword, String profilePicture) = _$_RegisterObject;
